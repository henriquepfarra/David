...
import { ArrowRight, BookOpen, CheckCircle2, ChevronRight, FolderOpen, Search, Sparkles, Brain } from "lucide-react";
            ...
            <div className="relative h-[calc(100vh-3rem)] overflow-hidden flex flex-col md:flex-row gap-6 p-6">
                ...
                >
                    ...
                    <div className="flex items-center gap-4 z-10 w-full flex-wrap">
                        <Button asChild size="lg" className="rounded-full shadow-lg hover:shadow-primary/25 h-12 text-base px-8 bg-primary text-primary-foreground hover:bg-primary/90">
                            <Link href="/david">
                        ...
                        <Button asChild variant="outline" size="lg" className="rounded-full h-12 text-base px-6 border-2 hover:bg-muted/50">
