...
import { ArrowRight, BookOpen, CheckCircle2, ChevronRight, FolderOpen, Search, Sparkles, LogIn } from "lucide-react";
...
export default function Home() {
  ...
  // Se estiver logado, redirecionar para /david
  if (user && !loading) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <div className="flex-1 flex flex-col items-center justify-center py-20 px-6 text-center lg:py-32 pt-32">
        <motion.div
      ...
      <footer className="border-t py-8 bg-background">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={APP_LOGO} alt={APP_TITLE} className="h-6 w-6 rounded-md opacity-60" />
            <span className="text-sm text-muted-foreground">© 2025 {APP_TITLE}</span>
          </div>
