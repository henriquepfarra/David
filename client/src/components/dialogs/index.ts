/**
 * Dialogs Module - Barrel export
 * 
 * Todos os diálogos extraídos de David.tsx na Fase 8 do plano de refatoração.
 */

export { DeletePromptDialog } from './DeletePromptDialog';
export { EditDraftDialog, type DraftType } from './EditDraftDialog';
